...
interface ConfigurationPanelProps {
  ...
  setSelectedAspectRatio: React.Dispatch<
      ...
      <div className="space-y-6">
            ...
            {durationOptions.map((option) => (
              <button
                ...
                onClick={() => {
                  ...
                  console.log(`Selected duration: ${option.value} seconds`)
                }}
                className={cn(
                  "py-3 px-1 rounded-xl text-sm font-medium transition-all duration-300",
                  "border",
        ...
        <div className="rounded-xl bg-gradient-to-b from-black/40 to-black/20  backdrop-blur-sm shadow-lg">
          ...
          <select
            ...
            onChange={(e) => {
              const newAspectRatio = aspectRatios.find(
                (ar) => ar.value === e.target.value
              );
        ...
        <div className="rounded-xl bg-gradient-to-b from-black/40 to-black/20  backdrop-blur-sm shadow-lg p-0">
          <h3 className="font-medium bg-gradient-to-r from-[#e7dfd6] to-[#bdc2c9] bg-clip-text text-transparent mb-3">
            Background Color
          </h3>
