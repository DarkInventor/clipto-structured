  ...
  export default function App() {
    ...
    const handleTwitterShare = () => {
      const text = encodeURIComponent("Hey, I just created this animation using Animator Studio!");
      const url = encodeURIComponent(renderedVideoUrl || window.location.href);
      window.open(`https://x.com/compose/post?text=${text}&url=${url}`, '_blank');
    };
        ...
        <main className="flex-1 flex flex-col bg-black overflow-hidden px-4">
          ...
          <motion.button
              ...
              className="text-black hover:from-[#bdc2c9] hover:to-[#e7dfd6] bg-gradient-to-r from-[#86868b] to-[#bdc2c9] 
                ...
                shadow-[0_0_15px_rgba(189,194,201,0.3)] font-[Poppins] font-medium"
            >
              Share on<span className='font-[900] ml-2 text-white bg-black px-[10px] rounded-[0.40rem]'> 𝕏</span>
            </motion.button>
              <button
                onClick={async () => {
